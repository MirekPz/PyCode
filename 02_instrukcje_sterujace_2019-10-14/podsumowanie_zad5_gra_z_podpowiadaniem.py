...
while counter < 6:
    number_provided = int(input("Zgadnij wylosowaną liczbę z zakresu od " + str(lower_range) + " do " + str(upper_range) + ": "))
    counter += 1
    if number_provided == number_drawn:
        print("\nGratulacje! Liczba odgadnięta poprawnie za " + str(counter) + " razem.")
        break
